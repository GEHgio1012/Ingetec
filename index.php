...
<section class="" >
    <div id="carouselExampleDark" class="slides carousel carousel-dark slide w3-margin-bottom " data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                <img class="imgsli" src="https://cdn.discordapp.com/attachments/907767557740699658/952746706968146001/Ingetec-Logo.jpg" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item" data-bs-interval="2000">
                <img class="imgsli" src="https://cdn.discordapp.com/attachments/907767557740699658/952746732024901712/Ingetec-Integrantes.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
        ...
        <p class="contenido_moral">
            <i>
                ...
                <ul class="list-group list-group-flush p-3">
                    <li class="list-group-item">Ingeniería de Software Aplicada al Cómputo Ubicuo.</li>
                    <li class="list-group-item">Innovación y Desarrollo Tecnológico.</li>
                </ul>
            <i>
        <p class="contenido_moral">
                ...
                <ul class="list-group list-group-flush p-3">
                    <li class="list-group-item">Computación Ubicua y Desarrollo de Interfaces Persona Ordenador</li>
                    <li class="list-group-item">Tecnologías Emergentes de la Información y Comunicación</li>
                    <li class="list-group-item">Cómputo en la Nube</li>
                </ul>
    </div>
</section>
</div>
...
<section>
    <div class="container margin p-3" id="noticias">
        ...
        <i>
            <p>
                (Apartado especial para las noticias que se incluiran a futuro como por ejemplo: )
            </p>
            <p class="contenido_blanco">
                Primer Foro Virtual de Tecnologías de la Información (FOVITEC 2021).
            </p>
            <p class="contenido_blanco">
                Proyecto "APROBADO" ante el TECNM - Convocatoria 2021: Proyectos de desarrollo tecnológico e innovación.
            </p>
            <p class="contenido_blanco">
                Participación en la 6a. Jornada de Ciencia y Tecnología Aplicada realizada del 21 al 23 de abril de 2021 en la ciudad de Cuernavaca, Morelos.
            </p>
            <p class="contenido_blanco">
                Presenta ponencia en el Congreso Regional en Computación y Tecnologías de la Información llevado a cabo el 2, 3 y 4 de Marzo de 2021. celebrado en CAMPUS DE LOS RIOS y CAMPUS ESCÁRCEGA.
            </p>
            <p class="contenido_blanco">
                INGETEC en capacitación.
            </p>
            <p class="contenido_blanco">
                Recibe importante reconocimiento el Cuerpo Académico "INGETEC" por parte de la Asociación Nacional de Instituciones Educativas en Tecnologías de Información (ANIEI).
            </p>
        </i>
    </div>
</section>
